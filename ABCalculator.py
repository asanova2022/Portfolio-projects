...
def popup_window(n1, c1, n2, c2):
    ...
    # Добавление вывода свободных разбросов
    z1 = 1.96
    ...
    txtOutput.insert(tk.END, '95% Воможный разброс  ' + os.linesep)
    ...
    txtOutput.insert(tk.END, '99% Воможный разброс  ' + os.linesep)
