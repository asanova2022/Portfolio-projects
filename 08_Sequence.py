...
def process_sales(sales):
    ...
    print("До 1000 р включительно: Количество продаж = " + str(cnt1) + " р Средний чек = " + str(avg1) + " р ")
    print("От 1000 р до 3000 р включительно: Количество продаж = " + str(cnt2) + " р Средний чек = " + str(avg2) + " р ")
    print("От 3000 р до 5000 р включительно: Количество продаж = " + str(cnt3) + " р Средний чек = " + str(avg3) + " р ")
    print("Выше 5000 р: Количество продаж = " + str(cnt4) + " р Средний чек = " + str(avg4) + " р ")
